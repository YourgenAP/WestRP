Locales['en'] = {
    ...
    ["TextNearMailboxLocation"]= "Press $1 to see your mail", --"Press $1 to see your mail or $2 to send a telegram to everyone", -- don't touch $, it is replaced with curent used key on runtime
    ["UICloseButton"]= "Close",
    ["UIWriteButton"]= "Write",
